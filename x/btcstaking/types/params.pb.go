...
type Params struct {
	...
	MinterAllowList []string `protobuf:"bytes,3,rep,name=minter_allow_list,json=minterAllowList,proto3" json:"minter_allow_list,omitempty"`
	// cross chain bridge contract address
	BridgeAddr string `protobuf:"bytes,4,opt,name=bridge_addr,json=bridgeAddr,proto3" json:"bridge_addr,omitempty"`
	// minimum satoshi per txout
	TxoutDustAmount int64 `protobuf:"varint,5,opt,name=txout_dust_amount,json=txoutDustAmount,proto3" json:"txout_dust_amount,omitempty"`
}
...
func (m *Params) GetMinterAllowList() []string {
	if m != nil {
...
func (m *Params) GetBridgeAddr() string {
	if m != nil {
		return m.BridgeAddr
	}
	return ""
...
func (m *Params) GetTxoutDustAmount() int64 {
	if m != nil {
		return m.TxoutDustAmount
	}
	return 0
}
...
var fileDescriptor_cc0c3789eee73a9d = []byte{
	...
	,
}
...
func (m *Params) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	var l int
	_ = l
	if m.TxoutDustAmount != 0 {
		i = encodeVarintParams(dAtA, i, uint64(m.TxoutDustAmount))
		i--
		dAtA[i] = 0x28
	}
	if len(m.BridgeAddr) > 0 {
		...
		i = encodeVarintParams(dAtA, i, uint64(len(m.BridgeAddr)))
		i--
		dAtA[i] = 0x22
	}
	if len(m.MinterAllowList) > 0 {
		for iNdEx := len(m.MinterAllowList) - 1; iNdEx >= 0; iNdEx-- {
			...
			i = encodeVarintParams(dAtA, i, uint64(len(m.MinterAllowList[iNdEx])))
			i--
			dAtA[i] = 0x1a
		}
	}
...
func (m *Params) Size() (n int) {
	...
	if m.TxoutDustAmount != 0 {
		n += 1 + sovParams(uint64(m.TxoutDustAmount))
	}
	return n
}
...
func (m *Params) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 5:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field TxoutDustAmount", wireType)
			}
			m.TxoutDustAmount = 0
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.TxoutDustAmount |= int64(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
