...
var (
	...
	ErrOpReturnData                = errorsmod.Register(ModuleName, 1108, "invalid op return data length")
	...
	ErrAgentIdNotFound             = errorsmod.Register(ModuleName, 1117, "agent id not found")
)
