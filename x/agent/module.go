...
import (
	...
	"github.com/Lorenzo-Protocol/lorenzo/v3/x/agent/client/cli"
...
// GetTxCmd returns the agent module's root tx command.
func (a AppModuleBasic) GetTxCmd() *cobra.Command {
	return cli.GetTxCmd()
}

// GetQueryCmd returns the agent module's root query command.
...
// ExportGenesis returns the agent module's exported genesis state as raw JSON bytes.
