...
type QueryHashesResponse struct {
	Hashes     []github_com_Lorenzo_Protocol_lorenzo_v2_types.BTCHeaderHashBytes `protobuf:"bytes,1,rep,name=hashes,proto3,customtype=github.com/Lorenzo-Protocol/lorenzo/v2/types.BTCHeaderHashBytes" json:"hashes,omitempty"`
...
type QueryContainsRequest struct {
	Hash *github_com_Lorenzo_Protocol_lorenzo_v2_types.BTCHeaderHashBytes `protobuf:"bytes,1,opt,name=hash,proto3,customtype=github.com/Lorenzo-Protocol/lorenzo/v2/types.BTCHeaderHashBytes" json:"hash,omitempty"`
}
...
func (*QueryFeeRateRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_77da53bf36dad620, []int{16}
}
...
func (*QueryFeeRateResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_77da53bf36dad620, []int{17}
}
...
func (m *QueryFeeRateResponse) GetFeeRate() uint64 {
	if m != nil {
		return m.FeeRate
	}
	return 0
...
func init() {
	...
	proto.RegisterType((*QueryFeeRateRequest)(nil), "lorenzo.btclightclient.v1.QueryFeeRateRequest")
	proto.RegisterType((*QueryFeeRateResponse)(nil), "lorenzo.btclightclient.v1.QueryFeeRateResponse")
}
...
var fileDescriptor_77da53bf36dad620 = []byte{
	...
	,
}
...
func (c *queryClient) FeeRate(ctx context.Context, in *QueryFeeRateRequest, opts ...grpc.CallOption) (*QueryFeeRateResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/lorenzo.btclightclient.v1.Query/FeeRate", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Query_FeeRate_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/lorenzo.btclightclient.v1.Query/FeeRate",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
