...
const (
	ClaimsType_CLAIM_REWARD_AND_WITHDRAW_BTC ClaimsType = 0
	ClaimsType_ONLY_CLAIM_REWARD             ClaimsType = 1
)

var ClaimsType_name = map[int32]string{
	0: "CLAIM_REWARD_AND_WITHDRAW_BTC",
	1: "ONLY_CLAIM_REWARD",
}

var ClaimsType_value = map[string]int32{
	"CLAIM_REWARD_AND_WITHDRAW_BTC": 0,
	"ONLY_CLAIM_REWARD":             1,
}
...
func (m *MsgClaims) GetClaimsType() ClaimsType {
	...
	return ClaimsType_CLAIM_REWARD_AND_WITHDRAW_BTC
}
...
var fileDescriptor_f54797b8bf30f2f9 = []byte{
	...
	,
}
