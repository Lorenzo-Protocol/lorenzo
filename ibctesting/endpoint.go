...
func (endpoint *Endpoint) CreateClient() (err error) {
	...
	case exported.Tendermint:
		...
		height := endpoint.Counterparty.Chain.LastHeader.GetHeight().(clienttypes.Height) //nolint:errcheck
...
func (endpoint *Endpoint) UpgradeChain() error {
	...
	clientState := endpoint.Counterparty.GetClientState().(*ibctm.ClientState) //nolint:errcheck
...
func (endpoint *Endpoint) QueryConnectionHandshakeProof() (
	...
	consensusHeight = clientState.GetLatestHeight().(clienttypes.Height) //nolint:errcheck
