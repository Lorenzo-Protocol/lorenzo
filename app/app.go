...
func NewLorenzoApp(
	...
	app.BTCStakingKeeper = btcstakingkeeper.NewKeeper(appCodec, keys[btcstakingtypes.StoreKey], app.BTCLightClientKeeper, app.AgentKeeper, app.BankKeeper, authtypes.NewModuleAddress(govtypes.ModuleName).String())
