...
import (
	...
	testutiltx "github.com/Lorenzo-Protocol/lorenzo/v3/testutil/tx"
...
func PrepareAccountsForDelegationRewards(t *testing.T, ctx sdk.Context, app *app.LorenzoApp, addr sdk.AccAddress, balance math.Int, rewards ...math.Int) (sdk.Context, error) {
