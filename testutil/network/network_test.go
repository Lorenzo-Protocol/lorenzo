...
import (
	...
	"github.com/Lorenzo-Protocol/lorenzo/testutil/network"

	lorenzonetwork "github.com/Lorenzo-Protocol/lorenzo/testutil/network"
)
...
func (s *IntegrationTestSuite) SetupSuite() {
	...
	var err error
	cfg := lorenzonetwork.DefaultConfig()
